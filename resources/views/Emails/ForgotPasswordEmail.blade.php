...
<body>
    <div class="container">
        <h4 style="color:#235667;">Reset your password</h4>
        <p>
            Hi {{ $mailData['user_name']}},
            <br> 
            You are receiving this email because we received a request to reset the password for your account. Please enter this confirmation code to reset your password.
        </p>
        <h4 style="color:#235667;">{{ $mailData['email_verification_code']}}</h4>
        <footer>
            <p>
